package dev.uwu.main.modules;

import dev.uwu.main.System;
...
public class ChorusPredict extends Module {
    ...
    public ChorusPredict() {
        super(System.CATEGORY, "chorus-predict", "Predicts the spot where the chorus-fruit will teleport you.");
    }
    ...
    private void onReceivePacket(PacketEvent.Receive event) {
        ...
        bpos = new BlockPos((int) packet.getX(), (int) packet.getY(), (int) packet.getZ());
